...
public class PullToRefreshLayout extends LinearLayout implements View.OnTouchListener{
    ...
    private AfterPullListener mListener;
    ...
    public PullToRefreshLayout(Context context, AttributeSet attributeSet){
        ...
        mHeader = LayoutInflater
                .from(context)
                .inflate(R.layout.header_mei_tuan, this, false);
        mFirstStepView = mHeader.findViewById(R.id.first_view);
        mSecondStepView = mHeader.findViewById(R.id.second_view);
        mThirdStepView = mHeader.findViewById(R.id.third_view);
       ...
       /* mSecondAnimOut = (AnimationDrawable) getResources()
                .getAnimation(R.anim.mt_pull_to_refresh_second_anim_out);*/
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if(mCurrentStatus != STATUS_REFRESHING){
                        ...
                        if(mCurrentStatus == STATUS_PULL_TO_REFRESH){
                            ...
                            ((MTFirstView)mFirstStepView).setProgress(progress);
    ...
    class RollToFinishedTask extends AsyncTask<Void, Integer, Integer>{
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            ((MTFirstView)mFirstStepView).setProgress(cProgress);
            mFirstStepView.postInvalidate();
        }
    ...
    public interface AfterPullListener{
        void onRefresh();
    }

    public void setAfterPullListener(AfterPullListener listener){
        mListener = listener;
    }
